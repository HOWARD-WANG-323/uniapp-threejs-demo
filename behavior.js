  ...
  return Behavior({
    ...
    methods: {
      ...
      initVK() {
        ...
        session.start(err => {
            ...
            loader.load('https://dldir1.qq.com/weixin/miniprogram/space_27f8c621878e44d8b05916163ce83b40.glb', gltf => {
              ...
              const calPosition = () => {
                ...
                if (hitTestRes.length) {
                  console.log('space has been added')
          ...
          if (options.robotModel) {
            const loader = new THREE.GLTFLoader()
            loader.load('https://versee-ar.obs.cn-south-1.myhuaweicloud.com/food%2813%29.glb', gltf => {
            // loader.load('https://file.ljcdn.com/bim-oss/20220318/1647595984497scene+282429.gltf', gltf => {
            // https://file.ljcdn.com/bim-oss/20220318/164760003133681467.glb
              this.model = {
                scene: gltf.scene,
      ...
      onResetPanel() {
        ...
        if (!this._insertModels) return
        this._insertModels.forEach(item => {
          if (item._mixer) {
            const mixer = item._mixer
            this.mixers.splice(this.mixers.indexOf(mixer), 1)
            mixer.uncacheRoot(mixer.getRoot())
